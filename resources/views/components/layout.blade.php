...
<body class="bg-black text-gray-200">
    ...
    <nav class="w-full p-4 border-b-2 border-gray-500">
      <ul class="flex flex-wrap justify-around max-w-[1200px] mx-auto">
        ...
        <li><a href="{{ route('guns.index') }}" class="link-default">Weapons</a></li>
      </ul>
    </nav>
    ...
    <main class="min-h-[700px] px-8 sm:px-4 py-12 max-w-[1200px] mx-auto">
      ...
      @if(session('success'))
      <div  class="bg-black w-full max-w-[1200px] my-4 mx-auto p-2 border-green-600 border-2 rounded-lg">
